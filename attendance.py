...
class Attendance:
    def __init__(self,root):
        ...
        #fist image
        img=Image.open(r"collage_images\std2.jpg")
        ...
        #second image
        img1=Image.open(r"collage_images\std.jpg")
        ...
        title_lbl=Label(bg_img,text="ATTENDANCE MANAGEMENT SYSTEM",font=("Perpetua",35,"bold"),bg="white",fg="green")
        ...
        img_left=Image.open(r"collage_images\classroom.jpg")
        ...
        #time 
        timelabel=Label(left_inside_frame,text="Date:",bg="white",font="comicsansns 11 bold")
        ...
        self.AttandanceReportTable=ttk.Treeview(table_frame,columns=("id","roll","name","department","time","date","attendance"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
